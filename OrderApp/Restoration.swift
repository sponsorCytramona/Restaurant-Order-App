...
extension NSUserActivity {
    ...
    var controllerIdentifier: StateRestorationController.Identifier? {
        get {
            if let contollerIdentifierString = userInfo?["controllerIdentifier"] as? String {
                return StateRestorationController.Identifier(rawValue: contollerIdentifierString)
            } else {
                return nil
            }
        }
